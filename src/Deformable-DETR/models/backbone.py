...
from .swin_transformer import build_swin_transformer, swin_backbones_list
...
def build_backbone(args):
    ...
    return_interm_indices = [1,2,3] #args.return_interm_indices
    assert return_interm_indices in [[0,1,2,3], [1,2,3], [3]]
    backbone_freeze_keywords = None #args.backbone_freeze_keywords
    ...
    elif args.backbone in swin_backbones_list:
        pretrain_img_size = int(args.backbone.split('_')[-2])
        if (hasattr(args, 'sampling_method') and hasattr(args, 'modality_regularization')) or args.modality_invariance_training:
            backbone = build_swin_transformer(args.backbone, \
                        ...
                        modality_regularization=args.modality_regularization,
                        output_target_modality_map=args.modality_invariance_training,
                        ir_modality_ratio=args.ir_modality_ratio)
        else:    
            backbone = build_swin_transformer(args.backbone, \
                        pretrain_img_size=pretrain_img_size, \
                        out_indices=tuple(return_interm_indices), \
    ...
    elif args.backbone in ['convnext_xlarge_22k', 'mixed_modality_convnext_xlarge_22k']:
